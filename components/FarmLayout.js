...
const NAV = [
  { href:'/dashboard',            icon:I.home,    label:'Tổng quan',            badge:null },
  { href:'/phan-tich-ky-thuat',  icon:I.chart,   label:'Phân tích kỹ thuật',  badge:null },
  { href:'/quan-ly-cam',         icon:I.feed,    label:'Quản lý cám',          badge:null },
  { href:'/flocks',              icon:I.chicken, label:'Đàn gà',               badge:null },
  { href:'/molting',             icon:I.molting, label:'Molting (Ép thay lông)',badge:null },
  { href:'/bao-cao',             icon:I.report,  label:'Báo cáo',              badge:null },
  { href:'/canh-bao',            icon:I.bell,    label:'Cảnh báo',             badge:8    },
  { href:'/cai-dat',             icon:I.settings,label:'Cài đặt',              badge:null },
];
  ...
  if (!ready) return (
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',background:'#0f1117'}}>
      <div style={{textAlign:'center'}}>
        ...
        <p style={{color:'#4ade80',fontSize:13,letterSpacing:1}}>Đang tải...</p>
      </div>
    </div>
  );
