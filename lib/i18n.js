...
export const T = {
  vi: {
    ...
    nav_report:    'Báo cáo',
    rpt_title:     'Báo Cáo Sản Xuất',
    rpt_week:      'Tuần',
    rpt_month:     'Tháng',
    rpt_period:    'Kỳ báo cáo',
    rpt_compare:   'So với kỳ trước',
    rpt_auto:      'Nhận xét tự động',
    rpt_egg_quality:'Chỉ số chất lượng trứng',
    rpt_zone_result:'Kết quả theo khu',
  ...
  ja: {
    ...
    rpt_compare:   '前期比較',
    rpt_auto:      '自動サマリー',
    rpt_egg_quality:'卵質指標',
    rpt_zone_result:'エリア別実績',
    rpt_export_pdf: 'PDF出力',
    nav_alert:     '警告',
    nav_settings:  '設定',
    role_admin:    '管理者',
    role_staff:    'スタッフ',
